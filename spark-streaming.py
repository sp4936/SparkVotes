...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "/home/patil/Real_time_voting_system_v1/postgresql-42.7.2.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/patil/Real_time_voting_system_v1/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
